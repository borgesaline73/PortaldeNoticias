...
<body>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav" >
                <ul class="navbar-nav ms-auto">
                    <li class="nav-item"><a class="nav-link" href="cadastrar.php">Adicionar Notícia</a></li>
                    <li class="nav-item"><a class="nav-link" href="indexpublico.php">Sair</a></li>
    ...
    <div class="add-news">
        <a href="cadastrar.php">Adicionar Mais Notícias</a>
    </div>
